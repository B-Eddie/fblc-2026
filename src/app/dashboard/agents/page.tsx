...
import { Users, Search, SlidersHorizontal, MapPin } from "lucide-react";
    ...
    <div className="p-8">
      <div className="mb-8">
        ...
        <p className="text-xs text-white/40 font-mono">
          Explore AI-generated customer personas and their preferences
        </p>
      </div>
        ...
        <div className="lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-3">
          {filteredAgents.map((agent) => (
            <button
              ...
              className={cn(
                "text-left border bg-black/40 p-4 hover:bg-white/5 transition-all",
          ...
          {selected ? (
            ...
            <div className="border border-white/10 bg-black/40 p-12 flex flex-col items-center justify-center text-center min-h-[400px]">
              ...
              <p className="text-xs text-white/20 font-mono">
                Click on a persona card to view their full profile
              </p>
            </div>
          )}
        </div>
